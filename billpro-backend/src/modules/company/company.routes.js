...
router.post('/', auditMiddleware('company', 'CREATE'), ctrl.createCompany);
...
router.route('/')
  .get(ctrl.getCompany)
  .put(restrictTo(ROLES.COMPANY_ADMIN), auditMiddleware('company', 'UPDATE'), ctrl.updateCompany);
...
// Branches
router.post('/branches', restrictTo(ROLES.COMPANY_ADMIN), ctrl.addBranch);
router.put('/branches/:branchId', restrictTo(ROLES.COMPANY_ADMIN), ctrl.updateBranch);
