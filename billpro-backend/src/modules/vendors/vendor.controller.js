...
const deleteVendor     = async (req, res, next) => { try { return sendSuccess(res, await vendorService.deleteVendor(req.companyId, req.params.id), 'Vendor deactivated'); } catch (e) { next(e); } };
